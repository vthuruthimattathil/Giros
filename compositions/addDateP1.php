...
<head>
 ...
 <title>Compositions - Ins&eacute;rer date composition</title>
...
<body>
 ...
 <div id="ww">
  ...
  <div id="cont"> 
   <h1>Ins&eacute;rer une date (composition):</h1>
   <form action="addDate.php" method="post" enctype="multipart/form-data" >
    <div>
     Entrez la nouvelle date: (format: jj/mm/aa)
...
<?php echo '   <input type="text" name="edtSalle" maxlength="25" value="'.$place.'"><br />' ?>
     Entrez le nombre maximal d'&eacute;l&eacute;ves:<br />
<?php echo '   <input type="text" name="edtMax" maxlength="2" value="'.$max.'10"><br />' ?>
     Entrez un commentaire:<br />
<?php echo '   <input type="text" name="edtComment" maxlength="64" value="'.$comment.'"><br />' ?>
...
?>
     ...
     <br />
     Type: <br />
     <input type="radio" name="rgType" value="0" checked="checked" >Devoir en classe - pas de d&eacute;part anticip&eacute;.</input> <br />
     <input type="radio" name="rgType" value="1" >Devoir en classe - D&eacute;part anticip&eacute;.</input> <br />
     <input type="radio" name="rgType" value="3" >Sport - pas de d&eacute;part anticip&eacute;.</input> <br />
